...
namespace SpecialJobs.Views.ForScenario
{
    ...
    /// </summary>
    public partial class WindowMeasuring_2_base : Window
    {
        ...
        private void gcUF_PastingFromClipboard(object sender, PastingFromClipboardEventArgs e)
        {
