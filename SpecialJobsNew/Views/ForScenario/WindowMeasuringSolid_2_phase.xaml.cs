...
namespace SpecialJobs.Views.ForScenario
{
    ...
    /// </summary>
    public partial class WindowMeasuringSolid_2_phase : Window
    {
        ...
        public WindowMeasuringSolid_2_phase()
        {
            InitializeComponent();
        ...
        {
            if (e.Column.FieldName == "MDA_UFCN_VALUE_IZM" || e.Column.FieldName == "MDA_UFN_VALUE_IZM")
