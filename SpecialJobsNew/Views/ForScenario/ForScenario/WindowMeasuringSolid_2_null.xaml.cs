...
namespace SpecialJobs.Views.ForScenario
{
    ...
    /// </summary>
    public partial class WindowMeasuringSolid_2_null : Window
    {
      ...
      //  public event Action<Object> pastingFromExcel;
        ...
        public WindowMeasuringSolid_2_null()
        {
            InitializeComponent();
        ...
        {
            this.Top = (SystemParameters.WorkArea.Height - gcU0.Height) / 2;
            this.Left = (SystemParameters.WorkArea.Width - gcU0.Width) / 2;
        }
